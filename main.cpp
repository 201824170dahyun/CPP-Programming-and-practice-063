...
int main()
{
	...
	while (window.isOpen())
    {
        ...
        while(running && !pause)
        {
        	while (window.pollEvent(event)) //  정다현 작성 
        	{
            if (event.type == Event::Closed)
                window.close();
        	}
        	
	        if (Keyboard::isKeyPressed(Keyboard::Space)) //  정다현 작성 
	        {
	        	if(!jumping)
				{
					jumping = true;
			...
			if (Keyboard::isKeyPressed(Keyboard::A)) //  정다현 작성 
	        {
	        	autoMode = true;	
			}
			
			if (Keyboard::isKeyPressed(Keyboard::U)) //  정다현 작성 
	        {
	        	autoMode = false;	
			}
			
			if (Keyboard::isKeyPressed(Keyboard::P)) //  정다현 작성 
			{
				pause = true;
			}
			...
			if (Keyboard::isKeyPressed(Keyboard::B)) // 최지광 작성  
			{
			...
			if(0 < bomb.BombSpeed()) // 최지광 작성  , 정다현 수정  
			{
				for(i = 0; i < 2; i++)
				{
			...
			for(i = 0; i < 2; i++) // 정다현 작성  최지광 수정 정다현 수정  
			{
		...
		if (Keyboard::isKeyPressed(Keyboard::H)) // 정다현 작성  
		{
			if(crash)
			{
				running = false;
		...
		if (Keyboard::isKeyPressed(Keyboard::S)) //정다현 작성  
		{
			if(!crash)
			{
				running = true;
		...
		if (Keyboard::isKeyPressed(Keyboard::R)) // 정다현 작성  
		{
			pause = false;
		}
		
		if (Keyboard::isKeyPressed(Keyboard::F)) // 정다현 작성  
		{
			flyMode = true;
		}
		
		if (Keyboard::isKeyPressed(Keyboard::D)) // 정다현 작성  
		{
			flyMode = false;
		}	
	}  
